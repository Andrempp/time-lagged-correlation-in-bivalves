...
import numpy as np
from functions.automts import imputation_methods, series_utils
import pandas as pd
...
def evaluate_singular(origData, predData, index, sensor):

    ##print(origData.isna().sum())
    #print(predData.isna().sum())
    #print("#"*20)
    origDataNA = origData.loc[index, sensor]
    predDataNA = predData.loc[index, sensor]
    #print(predDataNA)
    #print("origData:\n", origDataNA)
    #print(origDataNA.shape)
    #print("predData:\n", predDataNA)
    ...
    #print(origDataNA.isna().any())
    #print("*"*40)
    #print(predDataNA.isna().any())
    #print("origData:\n",origDataNA)
    #print("predData:\n",predDataNA)
    ...
    # Experimental
    ##################################
    ind = origData[sensor].dropna().index
    origDataNA = origData.loc[ ind, sensor]
    predDataNA = predData.loc[ ind, sensor]
    #print(origDataNA)
    #print(predDataNA)
