...
if(args[1] == 'mice'){
	...
	tempData <- mice(myData, m = strtoi(args[2], base = 0L), method = args[3], maxit = strtoi(args[4], base = 0L) , seed = strtoi(tail(args, n=1), base = 0L), printFlag=FALSE) #predictive mean matching being used pmm as default
